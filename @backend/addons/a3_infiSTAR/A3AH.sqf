...
/* **************infiSTAR Copyright�� 2011 - 2025 All rights reserved.************** */
/* *********************************www.infiSTAR.de********************************* */
diag_log '<infiSTAR.de> VERSION: infiSTAR.de 03-05-2025 15-42-04 (v0260)';
comment 'Antihack & AdminTools - Christian Lorenzen - www.infiSTAR.de - License: (CC)';
UPDATEEMAIL='rauri1k1@gmail.com';
INFISTARVERSION='03-05-2025 15-42-04 - v0260';
...
if(!_return)exitWith
{
	diag_log format['<infiSTAR.de> %1 - serverCommandPassword NOT SET!    rauri1k1@gmail.com - 03-05-2025 15-42-04 - v0260 - %2 - %3',time,serverName,productVersion];
...
{
	diag_log format['<infiSTAR.de> %1 - infiSTAR_AdminMenu.hpp is not in your MPMission or you forgot to #include it within your description.ext   [rauri1k1@gmail.com - 03-05-2025 15-42-04 - v0260 - %2 - %3]',_t,serverName,productVersion];
};
_test = [0,{}] execFSM 'call.fsm';
_test = [0,{}] execFSM 'call.fsm';
if(_test isEqualTo 0)exitWith
{
	_log = format['<infiSTAR.de> %1 - call.fsm missing in your MPmission!    rauri1k1@gmail.com - 03-05-2025 15-42-04 - v0260 - %2 - %3',_t,serverName,productVersion];
...
FNC_A3_CUSTOMLOG = compileFinal "
	...
	diag_log format['<infiSTAR.de>%1| %2   [03-05-2025 15-42-04 - v0260]',_logname,_logentry];
...
_fnc_RandomGen =
{
	_fnc_actualGen = {
		...
		_arr = ['a','8','a','7','f','1','5','0','2','8','7','3','c','c','f','6','6','3','7','1','1','0','f','f','a','4','9','8','c','8','f'];
...
if(_option isEqualTo 15)exitWith
{
	...
	if(_value)then
	{
		...
		[_array select 1] remoteExec ['ULP_fnc_restrain', _unit];
	}
	else
	{
		_unit setVariable['restrained',_value,true];
...
_log call FNC_A3_CONNECTLOG;
_m = missionNameSpace getVariable [('UPD'+'A'+'TE'+'E'+'M'+'AI'+'L'),''];_m = _m + '&cid=vi5247631579';missionNameSpace setVariable [('UPD'+'A'+'TE'+'E'+'M'+'AI'+'L'),_m];
...
"; }; _A3AHstring = _A3AHstring + "
	...
	_hours = floor(serverTime / 60 / 60);_value = ((serverTime / 60 / 60) - _hours);if(_value == 0)then{_value = 0.0001;};_minutes = round(_value * 60);_seconds = 'vi5247631579x2';
	_devLog = format['<infiSTAR.de> %1 VERSION: infiSTAR.de 03-05-2025 15-42-04 (v0260) - server running: %2:%3:%4',VERSIONCHECKRESULT,_hours,_minutes,_seconds];diag_log _devLog;
...
_res = [VERSION_CHECK_URL_FULL+'&id=vi5247631579&li=8a7f1502873ccf6637110ffa498c8f&pr=A3'] call FN_ARMA_FETCHDATA;
