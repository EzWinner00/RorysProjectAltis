...
_this spawn {
	...
	for "_i" from 0 to 1 step 0 do {
		...
		[3, "<t color='#ff0000' size='1.5px'>CSAT Airdrop<br/></t><t color='#ffffff' size='1px'>A helicopter is dropping supplies! The location will be marked on your map in 10 minutes."] remoteExecCall ["life_fnc_broadcast", RCLIENT];
		sleep _notifyTime;
		[3, "<t color='#ff0000' size='1.5px'>CSAT Airdrop<br/></t><t color='#ffffff' size='1px'>A helicopter is dropping supplies! The location will be marked on your map in 5 minutes."] remoteExecCall ["life_fnc_broadcast", RCLIENT];
		sleep _notifyTime;
		[3, format ["<t color='#ff0000' size='1.5px'>CSAT Airdrop<br/></t><t color='#ffffff' size='1px'>The supplies have been dropped! The location has been marked on your map."]] remoteExecCall ["life_fnc_broadcast", RCLIENT];
		sleep 1;
		...
		_markerText setMarkerText "CSAT Airdrop";
