...
switch (_title) do {
	...
	case "Perks": {
		...
		private _side = switch (playerSide) do {case west:{"Police"}; case civilian:{"Civilian"}; case independent:{"Medic"}; case east: {"CSAT"};};
	...
	case "Group Perks": {
		...
		_xpBar progressSetPosition (if (_reqXP > 0) then { _curXP / _reqXP } else { 0 });
