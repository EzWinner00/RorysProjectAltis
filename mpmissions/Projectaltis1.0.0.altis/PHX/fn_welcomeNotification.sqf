...
_array pushBack ["Welcome to Project Altis",([format["%1 Life", worldName]])];
_array pushBack ["Developed By",["Jobhu, 4KSIDEBURNS, JimothyPhillips"]];
_array pushBack ["Visit Our Website",["projectaltis.co.uk"]];
_array pushBack ["Join Our Teamspeak",["TS3.projectaltis.co.uk"]];
