...
class CfgSettings {
    ...
    donation_goal_paycheck_multiplier = 1.5; // Multiplier for the paychecks when donation goal is active (paycheck * multiplier)
    donation_goal_xp_multiplier = 1.25; // Multiplier for the xp when donation goal is active (paycheck * multiplier)
...
#include "..\Supercap\Configuration\CfgSupercap.hpp"
