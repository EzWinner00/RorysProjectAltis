...
class CfgHousing {
	class Altis {
		blacklistedHousing[] = {
            ...
            {"Land_i_Stone_Shed_V3_F",{10066.09,10183.294,0}},
            {"Land_i_Shed_Ind_F",{11396.24,14759.275,0}},
            {"Land_i_Shed_Ind_F",{9769.612,19413.33,0}},

        }; // POS of "Blacklisted" Housing

        class Land_i_Garage_V1_F {
            price = 700000;
            rent = 5000; // Up keep... (£252,000 Weekly)
            storage = 0;
            isGarage = true;
        ...
        class Land_i_House_Small_03_V1_F {
            price = 1357500;
            rent = 7000; // Up keep... (£420,000 Weekly)
            storage = 4;
            isGarage = false;
			garageSettings[] = {{0,0,0}, 0}; // POS, DIR
            lightPos[] = {-3.3,1,2.5};
        ...
        class Land_i_House_Big_02_V1_F {
            price = 1650000;
            rent = 2000; // Up keep... (£840,000 Weekly)
            storage = 4;
            isGarage = false;
			garageSettings[] = {{0,0,0}, 0}; // POS, DIR
            lightPos[] = {2,0,3.5};
		...
		class Land_i_House_Big_01_V1_F {
            price = 2200000;
            rent = 7000; // Up keep... (£1,260,000 Weekly)  lowered by alot
            storage = 5;
            isGarage = false;
			garageSettings[] = {{0,0,0}, 0}; // POS, DIR
            lightPos[] = {0,-2,3.8};
        ...
        class Land_i_Shed_Ind_F {
            price = 18500000;
            rent = 40000; // Up keep... (£85,000 Weekly)
            storage = 18;
            isGarage = true;
