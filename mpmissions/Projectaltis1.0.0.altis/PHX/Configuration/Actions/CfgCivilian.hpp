...
class blackMarket {
	actions[] = {
		{ "<t color='#b4a7d6'>[CIV]</t> Black Market Weaponry", "life_fnc_weaponShopMenu", "black_market", "(playerSide isEqualTo civilian) || { (player getVariable ['isCID', false]) || (player getVariable ['isHSS', false])}", 5 },
		{ "<t color='#ADFF2F'>[ATM]</t> Cashpoint", "PHX_fnc_atmMenu", "", "playerSide isEqualTo civilian", 5 }
	};
};
...
class drugDealer {
	actions[] = {
		{ "<t color='#ffe599'>[ALL]</t> Drug Dealer", "life_fnc_virt_menu", "drug_dealer", "playerSide isEqualTo civilian || playerSide isEqualTo east", 5 },
		{ "<t color='#073763'>[APC]</t> Question Dealer", "life_fnc_questionDealer", "", "playerSide isEqualTo west", 5 }
	};
};
class turtleDealer {
	actions[] = {
		{ "<t color='#ffe599'>[ALL]</t> Turtle Dealer", "life_fnc_virt_menu", "turtle_dealer", "playerSide isEqualTo civilian || playerSide isEqualTo east", 5 },
		{ "<t color='#073763'>[APC]</t> Question Dealer", "life_fnc_questionDealer", "", "playerSide isEqualTo west", 5 }
	};
};
class moonshineDealer {
	actions[] = {
		{ "<t color='#ffe599'>[ALL]</t> Moonshine Dealer", "life_fnc_virt_menu", "moonshine_dealer", "playerSide isEqualTo civilian || playerSide isEqualTo east", 5 },
		{ "<t color='#274e13'>[HAVOC]</t> Question Dealer", "life_fnc_questionDealer", "", "playerSide isEqualTo east", 5 }
	};
};
class goldBuyer {
	actions[] = {
		{ "<t color='#ffe599'>[ALL]</t> Gold Buyer", "life_fnc_virt_menu", "gold_buyer", "playerSide isEqualTo civilian || playerSide isEqualTo east", 5 }
	};
};
class offshoreAccountancy {
	actions[] = {
		{ "<t color='#ffe599'>[ALL]</t> Off-Shore Accountancy", "life_fnc_virt_menu", "offshore_accountancy", "playerSide isEqualTo civilian || playerSide isEqualTo east", 5 }
	};
};
class plutoniumTrader {
	actions[] = {
		{ "<t color='#ffe599'>[ALL]</t> Plutonium Dealer", "life_fnc_virt_menu", "plutonium_trader", "playerSide isEqualTo civilian || playerSide isEqualTo east", 5 }
	};
};
class antiqueTrader {
	actions[] = {
		{ "<t color='#ffe599'>[ALL]</t> Antique Trader", "life_fnc_virt_menu", "antique_trader", "playerSide isEqualTo civilian || playerSide isEqualTo east", 5 }
	};
};
class diamondTrader {
	actions[] = {
		{ "<t color='#ffe599'>[ALL]</t> Diamond Trader", "life_fnc_virt_menu", "diamond_trader", "playerSide isEqualTo civilian || playerSide isEqualTo east", 5 }
	};
};
class gemTrader {
	actions[] = {
		{ "<t color='#ffe599'>[ALL]</t> Gem Trader", "life_fnc_virt_menu", "gem_trader", "playerSide isEqualTo civilian || playerSide isEqualTo east", 5 }
	};
};
class uraniumDealer {
	actions[] = {
		{ "<t color='#ffe599'>[ALL]</t> Uranium Dealer", "life_fnc_virt_menu", "uranium_trader", "playerSide isEqualTo civilian || playerSide isEqualTo east", 5 }
	};
};
class oilTrader {
	actions[] = {
		{ "<t color='#ffe599'>[ALL]</t> Oil Trader", "life_fnc_virt_menu", "oil_trader", "playerSide isEqualTo civilian || playerSide isEqualTo east", 5 }
	};
};
class siliconExports {
	actions[] = {
		{ "<t color='#ffe599'>[ALL]</t> Silicon Exports", "life_fnc_virt_menu", "silicon_trader", "playerSide isEqualTo civilian || playerSide isEqualTo east", 5 }
	};
};
class metalTrader {
	actions[] = {
		{ "<t color='#ffe599'>[ALL]</t> Metal Trader", "life_fnc_virt_menu", "metal_trader", "playerSide isEqualTo civilian || playerSide isEqualTo east", 5 }
	};
};
class glassTrader {
	actions[] = {
		{ "<t color='#ffe599'>[ALL]</t> Glass Trader", "life_fnc_virt_menu", "glass_trader", "playerSide isEqualTo civilian || playerSide isEqualTo east", 5 }
	};
};
class saltTrader {
	actions[] = {
		{ "<t color='#ffe599'>[ALL]</t> Salt Trader", "life_fnc_virt_menu", "salt_trader", "playerSide isEqualTo civilian || playerSide isEqualTo east", 5 }
	};
};
class coralExports {
	actions[] = {
		{ "<t color='#ffe599'>[ALL]</t> Coral Exports", "life_fnc_virt_menu", "coral_exports", "playerSide isEqualTo civilian || playerSide isEqualTo east", 5 }
	};
};
class cigaretteExports {
	actions[] = {
		{ "<t color='#ffe599'>[ALL]</t> Cigarette Exports", "life_fnc_virt_menu", "cigarette_exports", "playerSide isEqualTo civilian || playerSide isEqualTo east", 5 }
	};
};
class cigarExports {
	actions[] = {
		{ "<t color='#ffe599'>[ALL]</t> Cigar Exports", "life_fnc_virt_menu", "cigar_exports", "playerSide isEqualTo civilian || playerSide isEqualTo east", 5 }
	};
};
class ephedrineDealer {
	actions[] = {
		{ "<t color='#ffe599'>[ALL]</t> Ephedrine Dealer", "life_fnc_virt_menu", "ephedrine_dealer", "playerSide isEqualTo civilian || playerSide isEqualTo east", 5 }
	};
};
class weaponParts1 {
	actions[] = {
		{ "<t color='#ffe599'>[ALL]</t> Weapon Parts Trader", "life_fnc_virt_menu", "weapon_parts_1", "playerSide isEqualTo civilian || playerSide isEqualTo east", 5 }
	};
};
class weaponParts2 {
	actions[] = {
		{ "<t color='#ffe599'>[ALL]</t> Weapon Parts Trader", "life_fnc_virt_menu", "weapon_parts_2", "playerSide isEqualTo civilian || playerSide isEqualTo east", 5 }
	};
};
class weapon_trader {
	actions[] = {
		{ "<t color='#ffe599'>[ALL]</t> Weapon Trader", "life_fnc_virt_menu", "weapon_trader", "playerSide isEqualTo civilian || playerSide isEqualTo east", 5 }
	};
};
class methdispensary {
	actions[] = {
		{ "<t color='#ffe599'>[ALL]</t> Meth Dispensary", "life_fnc_virt_menu", "ephedrine_dealer", "playerSide isEqualTo civilian || playerSide isEqualTo east", 5 }
	};
};
...
class civInternational {
	actions[] = {
		...
		{ "<t color='#b4a7d6'>[CIV]</t> Air Garage", "PHX_fnc_getGarage", {{"civ_international_spawn_1","civ_international_spawn_2"},"Air"}, "playerSide isEqualTo civilian", 5 },
...
class personalGarageRoy {
	actions[] = {
		{ "<t color='#ff66ff'>[CIV]</t> Car Garage", "PHX_fnc_getGarage", {{"personal_car_garage_roy_spawn"},"Car"}, "playerSide isEqualTo civilian", 5 },
		{ "<t color='#ff66ff'>[CIV]</t> Store Vehicle", "life_fnc_storeVehicle", {"Car"}, "playerSide isEqualTo civilian", 5 }
	};
};
...
class airGarageJamie {
	actions[] = {
		{ "<t color='#b4a7d6'>[CIV]</t> Air Garage", "PHX_fnc_getGarage", {{"personal_air_garage_jamie_spawn_1","civ_air_garage_abandoned_spawn_2"},"Air"}, "playerSide isEqualTo civilian", 5 },
		{ "<t color='#b4a7d6'>[CIV]</t> Store Vehicle", "life_fnc_storeVehicle", {"Air"}, "playerSide isEqualTo civilian", 5 }
	};
};
...
class casinoHack {
	actions[] = {
		{ "<t color='#ffe599'>[ALL]</t> Hack Vault", "PHX_fnc_hackObject", "Casino", "playerSide in [civilian, east] && { isNil { _target getVariable ""inUse"" } }", 5 },
		{ "<t color='#073763'>[APC]</t> Remove Malicious Software", "PHX_fnc_revertHack", "Casino", "playerSide isEqualTo west && { isNil { _target getVariable ""inUse"" } }", 5 }
	};
};
