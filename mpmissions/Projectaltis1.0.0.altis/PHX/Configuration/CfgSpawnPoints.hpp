...
class CfgSpawnPoints {
    class Altis {
        ...
        class CSAT {
            class CSAT_HQ {
                displayName = "CSAT HQ";
                spawnMarker = "csat_spawn";
                icon = "\a3\ui_f\data\map\MapControl\bunker_ca.paa";
                conditions = "";
            };
            class CSAT_Kubinka {
                displayName = "Camp Kubinka";
                spawnMarker = "csat_spawn_1";
                icon = "\a3\ui_f\data\map\MapControl\bunker_ca.paa";
                conditions = "";
            };
            class CSAT_Tambov {
                displayName = "Camp Tambov";
                spawnMarker = "csat_spawn_2";
                icon = "\a3\ui_f\data\map\MapControl\bunker_ca.paa";
                conditions = "";
            };
            class CSAT_Krichev {
                displayName = "Camp Krichev";
                spawnMarker = "csat_spawn_3";
                icon = "\a3\ui_f\data\map\MapControl\bunker_ca.paa";
                conditions = "";
            };
            class CSAT_Magos {
                displayName = "Camp Magos";
                spawnMarker = "csat_spawn_4";
                icon = "\a3\ui_f\data\map\MapControl\bunker_ca.paa";
                conditions = "";
            };
            class CSAT_Viper {
                displayName = "Viper HQ";
                spawnMarker = "csat_spawn_5";
                icon = "\a3\ui_f\data\map\MapControl\bunker_ca.paa";
                conditions = "call life_hsflevel >= 1";
            };
        };
    };
