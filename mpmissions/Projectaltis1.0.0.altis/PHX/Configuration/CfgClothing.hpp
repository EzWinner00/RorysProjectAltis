...
class CfgClothing {
    ...
    class Altis {
        ...
        class diving_store {
            ...
            backpacks[] = {
                { "NONE", "Remove Backpacks", 0, "true" },
                { "B_SCBA_01_F", "", 18000, "true" },
                { "B_CombinationUnitRespirator_01_F", "", 14000, "true" },
        ...
        class rebel_store {
            ...
            uniforms[] = {
                ...
                { "U_C_Man_casual_2_F", "Gang Skin", 200, "['TMC', player] call PHX_fnc_inWhitelistGang" }, // Gang Skin
                { "U_I_CombatUniform", "Gang Skin", 10000, "['TwoPointNine', player] call PHX_fnc_inWhitelistGang" }, // Gang Skin
                { "U_I_CombatUniform", "Gang Skin", 10000, "['MBWS', player] call PHX_fnc_inWhitelistGang" }, // Gang Skin
            ...
            vests[] = {
                ...
                { "V_PlateCarrier2_blk", "", 50000, "(license_civ_PMC || { (player getVariable ['isCID', false]) || (player getVariable ['isHSS', false])}) && PHX_DonatorLevel > 0 || ['TwoPointNine', player] call PHX_fnc_inWhitelistGang" },
        ...
        class black_market_clothing {
            ...
            uniforms[] = {
                ...
                { "U_B_CombatUniform_mcam_tshirt", "", 10000, "true" },
                { "U_B_CombatUniform_mcam_worn", "", 10000, "true" },
                { "U_O_R_Gorka_01_black_F", "", 21000, "true" },
                { "U_B_CTRG_1", "", 10000, "license_civ_PMC || { (player getVariable ['isCID', false]) || (player getVariable ['isHSS', false])}" },
                { "U_B_CTRG_2", "", 10000, "license_civ_PMC || { (player getVariable ['isCID', false]) || (player getVariable ['isHSS', false])}" },
                { "U_B_CTRG_3", "", 10000, "license_civ_PMC || { (player getVariable ['isCID', false]) || (player getVariable ['isHSS', false])}" },
                { "U_I_G_Story_Protagonist_F", "", 10000, "true" },
        ...
        class apc_clothing {
            ...
            uniforms[] = {
                { "NONE", "Remove Uniform", 0, "true" },
                { "U_Rangemaster", "Police Uniform", 0, "call life_coplevel >= 1" }
            };
            headgear[] = {
                { "NONE", "Remove Headgear", 0, "true" },
        ...
        class havoc_clothing {
            ...
            uniforms[] = {
                ...
                { "U_IG_Guerilla2_1", "Covert Uniform 1", 0, "call life_havoclevel >= 1" },
                { "U_OG_Guerilla2_3", "Covert Uniform 2", 0, "call life_havoclevel >= 1" },
                { "U_BG_Guerilla1_1", "Covert Uniform 3", 0, "call life_havoclevel >= 1" },
                { "U_BG_Guerilla1_2_F", "Covert Uniform 4", 0, "call life_havoclevel >= 1" },
                { "U_BG_Guerilla2_2", "Covert Uniform 5", 0, "call life_havoclevel >= 1" },
                { "U_OG_Guerilla3_1", "Covert Uniform 6", 0, "call life_havoclevel >= 1" },
                { "U_BG_leader", "Covert Uniform 7", 0, "call life_havoclevel >= 1" },
                { "U_O_T_Soldier_F", "Standard Uniform", 0, "call life_havoclevel >= 2" },
                { "U_O_T_Sniper_F", "Half Ghillie Suit", 0, "call life_havoclevel >= 4 || call life_hsflevel >= 1" },
                { "U_O_T_FullGhillie_tna_F", "Full Ghillie Shuit", 0, "call life_havoclevel >= 5 || call life_hsflevel >= 2" },
                // { "U_O_officer_noInsignia_hex_F", "Lieutenant Attire", 0, "call life_havoclevel >= 6" },
                { "U_O_T_Officer_F", "Command Uniform", 0, "call life_havoclevel  >= 6" },
                // { "U_O_CombatUniform_ocamo", "Colonel Combat Fatigues (Hex)", 0, "call life_havoclevel  >= 8" },
                { "U_O_CombatUniform_oucamo", "Colonel Combat Fatigues (Urban)", 0, "call life_havoclevel  >= 8" },
                { "U_O_V_Soldier_Viper_F", "Viper Uniform", 0, "call life_havoclevel >= 7 || call life_hsflevel >= 1" }

            };
            headgear[] = {
                { "NONE", "Remove Headgear", 0, "true" },
                { "H_HelmetB", "Combat Helmet", 500, "call life_havoclevel >= 1" },
                { "H_CrewHelmetHeli_O", "Pilot Helmet", 500, "call life_havoclevel >= 1" },
                { "H_Booniehat_grn", "Booniehate (Green)", 0, "call life_havoclevel >= 1" },

                { "H_Cap_grn", "", 0, "call life_havoclevel >= 1" },
                { "H_Cap_blu", "", 0, "call life_havoclevel >= 1" },
                { "H_Cap_surfer", "", 0, "call life_havoclevel >= 1" },
                { "H_Cap_blk_Raven", "", 0, "call life_havoclevel >= 1" },
                { "H_Cap_oli_hs", "", 0, "call life_havoclevel >= 1" },
                { "H_Hat_camo", "", 0, "call life_havoclevel >= 1" },
                { "H_Shemag_olive", "", 250, "call life_havoclevel >= 1" },

                { "H_HelmetO_ghex_F", "Protector Helmet", 500, "call life_havoclevel >= 2" },
                { "H_MilCap_grn", "Military Cap", 250, "call life_havoclevel >= 2" },
                { "H_MilCap_wdl", "", 500, "call life_havoclevel >= 5" },
                { "H_MilCap_eaf", "", 500, "call life_havoclevel >= 5" },
                { "H_Cap_red", "", 0, "call life_havoclevel >= 6" },
                { "H_Beret_CSAT_01_F", "Command Beret", 500, "call life_havoclevel >= 6" },
                { "H_HelmetSpecO_ghex_F", "Viper Helmet", 500, "call life_havoclevel >= 7 || call life_hsflevel >= 1" },
                { "H_HelmetO_oucamo", "Colonel Helmet", 500, "call life_havoclevel >= 8" }
                
            };
            goggles[] = {
                { "NONE", "Remove Glasses", 0, "true" },
                { "G_AirPurifyingRespirator_02_olive_F", "Operations Mask", 250, "call life_havoclevel >= 1" },
                { "G_Balaclava_combat", "", 500, "call life_havoclevel >= 2" },
                { "G_Balaclava_TI_blk_F", "", 500, "call life_havoclevel >= 2" },
                { "G_Balaclava_TI_G_blk_F", "", 500, "call life_havoclevel >= 2" },
                { "G_Balaclava_blk", "", 250, "call life_havoclevel >= 2" },
                { "G_Balaclava_oli", "", 250, "call life_havoclevel >= 2" },
                { "G_Bandanna_oli", "", 250, "call life_havoclevel >= 1" },
                { "G_Bandanna_aviator", "", 250, "call life_havoclevel >= 1" },
                { "G_Squares", "", 0, "true" },
                { "G_Shades_Blue", "", 0, "true" },
                { "G_Sport_Blackred", "", 0, "true" },
                { "G_Sport_Checkered", "", 0, "true" },
                ...
                { "G_Lady_Blue", "", 0, "true" },
                { "G_Spectacles", "", 0, "true" },
                { "G_Tactical_Clear", "Night Vision Glasses", 500, "true" }
            };
            vests[] = {
                { "NONE", "Remove Vest", 0, "true" },
                { "V_PlateCarrier1_rgr_noflag_F", "Covert Vest", 15000, "call life_havoclevel >= 1" },
                { "V_TacVest_oli", "", 15000, "call life_havoclevel >= 2" },
                { "V_HarnessO_ghex_F", "", 15000, "call life_havoclevel >= 2" },
                { "V_HarnessOGL_ghex_F", "", 15000, "call life_havoclevel >= 2" },
                { "V_BandollierB_ghex_F", "", 15000, "call life_havoclevel >= 2" },
                { "V_Chestrig_oli", "", 15000, "call life_hsflevel >= 1" },
                { "V_TacVest_blk", "", 15000, "call life_havoclevel >= 7 || call life_hsflevel >= 1" }
                // { "V_PlateCarrier3_rgr", "", 15000, "call life_havoclevel >= 2" },
                // { "V_I_G_resistanceLeader_F", "Camo Vest", 15000, "call life_havoclevel >= 6" },
                // { "V_RebreatherIR", "", 5000, "call life_havoclevel >= 2"}
            };
            backpacks[] = {
                { "NONE", "Remove Backpacks", 0, "true" },
                ...
                { "B_ViperHarness_ghex_F", "Viper Backpack", 2500, "call life_hsflevel >= 1" },
                { "B_Parachute", "Parachute", 10000, "call life_havoclevel >= 2" }
            };
        };
    };
};
