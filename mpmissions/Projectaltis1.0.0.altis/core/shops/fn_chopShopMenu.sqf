...
if !(playerSide isEqualTo civilian) exitWith {["Your faction is not allowed to chop vehicles!", "red"] call PHX_fnc_notify;};
...
if (PHX_isWaring) exitWith {["You cannot use chop shop when gang wars is active!","red"] call PHX_fnc_notify;};
